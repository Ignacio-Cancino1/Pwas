...
function preload() {
  // Cargar las imágenes
  fondoImg = loadImage('images/cesped.jpg');
  paredImg = loadImage('images/ladrillos.jpg');
  jugadorImg = loadImage('images/player.png');
  metaImg = loadImage('images/meta.png');
  
  // Cargar sonidos
  moveSound = loadSound('sounds/movement.mp3', () => moveSound.playMode('sustain'));
  goalSound = loadSound('sounds/complet.mp3', () => goalSound.playMode('sustain'));
  wallHitSound = loadSound('sounds/chocarpared.mp3', () => wallHitSound.playMode('sustain'));
}
